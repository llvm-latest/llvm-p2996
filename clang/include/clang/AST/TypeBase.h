...
protected:
  TypeWithKeyword(ElaboratedTypeKeyword Keyword, TypeClass tc,
                  ...
                  bool isConstevalOnly)
      : KeywordWrapper(Keyword, tc, Canonical, Dependence, isConstevalOnly) {}
};
  ...
  DeducedTemplateSpecializationType(ElaboratedTypeKeyword Keyword,
      ...
      : KeywordWrapper(
            ...
            toTypeDependence(Template.getDependence()) |
                (IsDeducedAsDependent ? TypeDependence::DependentInstantiation
                                      : TypeDependence::None),
            Canon
            /*ConstevalOnly=<deduced by DeducedType>*/),
        Template(Template) {}
...
class DependentNameType : public TypeWithKeyword, public llvm::FoldingSetNode {
  ...
  DependentNameType(ElaboratedTypeKeyword Keyword, NestedNameSpecifier NNS,
      ...
      : TypeWithKeyword(Keyword, DependentName, CanonType,
                        ...
                        /*ConstevalOnly=*/!CanonType.isNull()
                            ? CanonType->isConstevalOnly()
                            : false),
        NNS(NNS), Name(Name) {
    assert(Name);
  }
...
private:
  PredefinedSugarType(Kind KD, const IdentifierInfo *IdentName,
      ...
      : Type(PredefinedSugar, CanonicalType, TypeDependence::None,
             /*ConstevalOnly=*/!CanonicalType.isNull()
                 ? CanonicalType->isConstevalOnly()
                 : false),
        Name(IdentName) {
